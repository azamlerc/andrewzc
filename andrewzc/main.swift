...
let cityLists = ["capitals", "twin-cities", "congestion", "culture", "divided", "homes", "money-heist", "newcastle", "olympics", "tintin", "aop", "worldsfair", "eurovision", "planned", "spa-towns", "belfries", "germany", "belgium", "states"]
let middleSectionBeen = ["twin-cities", "border-posts", "confluence", "ferries", "tripoints", "awa", "states"]
let yearPrefix = ["olympics", "worldsfair", "automatic", "gauges", "projects", "left-to-right", "highest", "lowest", "europe-2003", "high-speed", "concerts", "eclipses", "people-movers", "eurovision", "timezones", "independence", "founded", "unification", "fare-free", "open-gangways", "metro-prices", "metro-population"]
...
let loadCoords: [String] = [] // how to get "mexico-city"?
